...
export class AiService {
  ...
  providers() {
    return [this.openAiKey && 'openai', this.geminiKey && 'gemini'].filter(Boolean);
  }
  ...
  status(safeBrowsingEnabled = false) {
    ...
    return {
      ...
      models: {
        ...(this.openAiKey ? { openai: this.openAiModel } : {}),
        ...(this.geminiKey ? { gemini: this.geminiModel } : {}),
      },
  ...
  requireProvider(requested) {
    ...
    const provider = supplied || this.defaultProvider;

...
export class PodStore {
  ...
  cacheActor(url, doc) {
    ...
    a[url] = {
      ...
      // Mastodon's fediverse:creator allow-list. Keep only bounded domain-like
      // strings; the authoritative match revalidates them before use.
      attributionDomains: [].concat(doc.attributionDomains || []).slice(0, 100)
